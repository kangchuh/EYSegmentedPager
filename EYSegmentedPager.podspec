...
Pod::Spec.new do |s|
  ...
  s.homepage         = "https://github.com/kangchuh/EYSegmentedPager"
  s.license          = 'MIT'
  s.author           = { "Maxime Epain" => "gangshuai08@gmail.com" }
  s.source           = { :git => "https://github.com/kangchuh/EYSegmentedPager.git", :tag => s.version.to_s }
  s.social_media_url = 'https://twitter.com/KangChuh'
  ...
  s.dependency 'MXParallaxHeader', '1.0.0'
